#Как я понял, во флэтпейджах нужно соответствующим страницам прописывать путь до соответствующего html кода. Они преставленны у меня в виде трех кодов папки flatpages
